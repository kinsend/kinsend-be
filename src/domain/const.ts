...
export enum TYPE_PAYMENT {
  ...
  A2P_BRAND_CAMPAIGN_REGISTRATION = 'A2P_BRAND_CAMPAIGN_REGISTRATION',
}
...
export const STARTER_BRAND_REGISTRATION = 4; // 4$

export const STANDARD_BRAND_REGISTRATION = 44; // 44$
